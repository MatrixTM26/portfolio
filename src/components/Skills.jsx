...
const PROFICIENCY = [
  ...
  { icon: 'fa-solid fa-terminal',         name: 'Low-Level & High-Level Language Scripting', pct: 75 },
...
const CATEGORIES = [
  ...
  { icon:'fa-solid fa-magnifying-glass',name:'Reconnaissance',     tags:['Subdomain Enum','Port Scan','Google Dork','DNS Enum','Shodan']        },
    ...
    <section className="section skills" id="skills">
      ...
      <div className="container">
        ...
        <div className="skills-layout">
          <div className={`skills-proficiency reveal-left${leftCol.visible ? ' visible' : ''}`} ref={leftCol.ref}>
            <div ref={barsRef}>
              {PROFICIENCY.map((s, i) => (
                <SkillBar key={s.name} icon={s.icon} name={s.name} pct={s.pct} visible={barsVisible} delay={i * 100} />
              ))}
            </div>
          </div>
