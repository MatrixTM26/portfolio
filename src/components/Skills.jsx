...
const ALL_SKILLS = [
    ...
    {
        img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rust/rust-original.svg",
        name: "Rust"
    },
    {
    ...
    {
        img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/gradle/gradle-original.svg",
        name: "Gradle"
    },
    {
        img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/maven/maven-original.svg",
        name: "Maven"
    },
    {
        ...
        <div className="skill-chip">
            {item.img ? (
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className={item.inv ? "icon-invert" : ""}
                />
            ) : (
                <i className={`${item.fa} skill-fa`} aria-hidden="true" />
            )}
            <span>{item.name}</span>
        </div>
    );
...
function Belt({ items, dir }) {
    ...
    return (
        <div className={`skill-belt ${dir}`} aria-hidden="true">
            {doubled.map((item, i) => (
    ...
    return (
        <section className="section skills" id="skills">
            ...
            <div className="container">
                ...
                <div
                    className={`skill-belt-wrap reveal${belts.visible ? " visible" : ""}`}
                    ref={belts.ref}
                >
                ...
                <div
                    className={`skill-categories-grid reveal${cats.visible ? " visible" : ""}`}
                    ref={cats.ref}
                >
                    {CATEGORIES.map((cat, i) => (
                        ...
                        >
                            <div className="skill-cat-top">
                                <i
                                    className={`${cat.icon} skill-cat-icon`}
                                    aria-hidden="true"
                                />
