...
export default function Skills() {
    ...
    return (
        <section className="skills" id="skills">
            <div
                className="skills-layer skills-layer-1"
                data-parallax="depth-1"
            />
            <div
                className="skills-layer skills-layer-2"
            ...
            <div className="container">
                <div className="skills-top">
                    ...
                    <div
                        className={`skills-img-card reveal-right${header.visible ? " visible" : ""}`}
                    >
                ...
                <div className="skills-bottom">
                    ...
                    <div
                        className={`skills-tool-img reveal-right${toolsRow.visible ? " visible" : ""}`}
                    >
