...
const PROFICIENCY = [
    ...
    { icon: "fa-solid fa-bug", name: "Bug Bounty Hunting", pct: 78 },
    {
        ...
        name: "Low-Level & High-Level Lang Scripting",
        pct: 75
    },
    {
...
const CYBER_IMAGES = [
    { src: "/skill.jpg", alt: "Cybersecurity terminal" },
    { src: "/arsenal.jpg", alt: "Network security" }
];
        ...
        <section className="section skills" id="skills">
            ...
            <div className="container">
                <div className="skills-section-top">
                    ...
                    >
                        ...
                        <p className="section-desc">
                            ...
                            — from CTF competitions to live bug bounty programs
                            and hands-on penetration testing engagements.
                        </p>
                    </div>

                    <div
                        className={`skills-img-accent reveal-right${img1Ref.visible ? " visible" : ""}`}
                        ref={img1Ref.ref}
                    >
                        <img
                            src={CYBER_IMAGES[0].src}
                            alt={CYBER_IMAGES[0].alt}
                        />
                ...
                <div className="skills-bottom">
                    ...
                    <div
                        className={`skills-img-accent skills-img-bottom reveal-left${img2Ref.visible ? " visible" : ""}`}
                        ref={img2Ref.ref}
                    >
                        <img
                            src={CYBER_IMAGES[1].src}
                            alt={CYBER_IMAGES[1].alt}
                        />
                        <div className="img-overlay" />
                    </div>
                </div>
