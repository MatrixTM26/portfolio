    ...
    <>
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <div className="navbar-inner">
          <a href="#home" className="nav-logo" onClick={() => { closeMobile(); closeDrawer() }}>
          ...
          <div className="nav-desktop">
            ...
            <a href="#contact" className="nav-cta-desktop" onClick={() => setActive('#contact')}>
              Let's Talk
            </a>
            <button
      ...
      <div className={`nav-drawer${drawerOpen ? ' open' : ''}`}>
          ...
          {NAV_ITEMS.map(item => (
            <li key={item.href}>
              <a
                href={item.href}
                className={active === item.href ? 'active' : ''}
                onClick={() => { setActive(item.href); closeDrawer() }}
              >
                <i className={item.icon} />
                {item.label}
              </a>
        ...
        <div className="drawer-footer">
          <a href="#contact" className="drawer-cta" onClick={() => { setActive('#contact'); closeDrawer() }}>
            <i className="fa-solid fa-paper-plane" />
            Let's Talk
          </a>
        </div>
