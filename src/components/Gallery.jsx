...
export default function Gallery() {
    ...
    const getSlideClass = useCallback(
        i => {
            if (i === flipping)
                return direction === "next" ? "flip-out" : "flip-out-reverse";
    ...
    return (
        <section className="section gallery" id="gallery">
            <div
                className="gallery-bg-layer"
                data-parallax="slow"
                aria-hidden="true"
            />
            <div className="container">
                <div
                    className={`gallery-header reveal${header.visible ? " visible" : ""}`}
                    ref={header.ref}
                >
                ...
                <div
                    className={`reveal${content.visible ? " visible" : ""}`}
                    ref={content.ref}
                >
                    <div
                    ...
                    >
                        {ITEMS.map((item, i) => (
                            <div
                                key={i}
                                className={`gallery-slide ${getSlideClass(i)}`}
