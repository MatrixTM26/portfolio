                ...
                <div className="contact-top">
                    ...
                    >
                        ...
                        <p className="section-desc">
                            Have a security project, bug bounty collaboration,
                            or just want to connect? Drop a message and I'll
                            respond promptly.
                        </p>
                    </div>

                    <div
                        className={`contact-img-accent reveal-right${imgReveal.visible ? " visible" : ""}`}
                        ref={imgReveal.ref}
                    >
                    ...
                    >
                        ...
                        <div className="contact-availability">
                            ...
                            <span className="avail-text">
                                ...
                                freelance security engagements and bug bounty
                                collaborations.
                            </span>
                        </div>
                    </div>
