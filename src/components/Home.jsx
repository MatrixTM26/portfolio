        ...
        <div className="home-inner">
          ...
          <div className={`home-left reveal-left${left.visible ? ' visible' : ''}`} ref={left.ref}>
            ...
            <div className="home-cta">
              ...
              <a href="#skills" className="btn-ghost">Learn More</a>
            </div>
            ...
            <div className="profile-section">
              <div className="profile-avatar-wrap" data-parallax="reverse">
                ...
                <div className="profile-circle">
                  <img src="/profile.png" alt="MatrixTM26" className="profile-img" />
                </div>
              </div>
              <div className="profile-info">
                <h2 className="profile-name">MatrixTM26</h2>
                <p className="profile-title">Penetration Tester · Bug Hunter</p>
                <div className="profile-badges">
                  <div className="profile-badge">
                    <i className="fa-solid fa-shield-halved" /><span>Open to Work</span>
                  </div>
                  <div className="profile-badge">
                    <i className="fa-solid fa-trophy" /><span>50+ CTF Solved</span>
                  </div>
                </div>
              </div>
            </div>
