                ...
                <div className="home-inner">
                    <div className="home-left">
                        ...
                        <h1 className="home-headline">
                            Providing the Best
                            <br />
                            <span className="accent-word">Cyber</span> Solutions
                            <br />
                            for Your{" "}
                            <span className="outline-word">Security</span>
                        </h1>

                        <p className="home-desc">
                            I'm ready to protect your data from hackers. I
                            specialize in penetration testing, vulnerability
                            research, bug bounty hunting, and CTF competitions —
                            keeping your systems one step ahead of threats.
                        </p>
                        ...
                        <div className="profile-wrap">
                            ...
                            <div className="profile-card-floating card-top">
                                ...
                                <div className="floating-card-text">
                                    ...
                                    <span className="floating-card-value">
                                        Open to Work
                                    </span>
                                </div>
                            </div>
